<?php if ($mobile) { ?>
    <div class="row">
        <div class="col-md-12">
            <div class="container-fluid comment-section-wrapper">
                <span class="icon-uniE922 sidebar-moon-icon-size white-color-link middle-content-padding"></span>
                <?php if ($mobile) { ?>
                    <span class="align-to-moon-icon-mobile white-color-link">SİZDEN GELENLER</span>
                <?php } else { ?>
                    <span class="align-to-moon-icon white-color-link">SİZDEN GELENLER</span>
                <?php } ?>
...
<?php } else { ?>
    <div class="row middle-content-wrapper padding-20px">
        <div class="col-md-12">
            <div class="container-fluid comment-section-wrapper">
                <span class="icon-uniE922 sidebar-moon-icon-size white-color-link middle-content-padding"></span>
                <?php if ($mobile) { ?>
