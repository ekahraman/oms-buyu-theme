 ...
 <div class="container">
    <div class="row dua-section-wrapper">
        <div class="col-md-12" style="background-color:white">
            <h2 class="bold">Üzüntülü İken Okunacak Dua</h2>
    ...
    <div class="container top-margin-before-slider">
        ...
        <div class="col-md-9 middle-content-wrapper background-color-white"><!-- ====================================== Hocamızdan Yazılar ===================================== -->
            ...
            <span class="<?=$icon_moon_span?>">Üzüntülü İken Okunacak Dua</span>
                    ...
                    <form class="form-inline margin-top-15px">
                        <div class="form-group col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control align-input2" id="" placeholder="Adı Soyadı" style="border-left:0 !important;">
                            </div>
                        </div>
                        <div class="form-group pull-right col-md-6">
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-envelope-o fa-fw"></i></div>
                                <input type="text" class="form-control align-input2" id="" placeholder="E-Posta Adresi" style="border-left:0 !important;">
                            </div>
                        </div>
                        <div class="row">&nbsp;</div>
